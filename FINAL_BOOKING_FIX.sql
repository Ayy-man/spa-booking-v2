...
-- Run this COMPLETE script in your Supabase SQL Editor to fix all booking issues
-- This script addresses: "invalid input syntax for type time: 'Inval'" and related errors

-- =============================================================================
-- PART 1: Remove problematic triggers (if they exist)
-- =============================================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ BOOKING SYSTEM FIXES APPLIED SUCCESSFULLY!';
