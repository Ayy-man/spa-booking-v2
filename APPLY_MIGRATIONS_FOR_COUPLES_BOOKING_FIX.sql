-- ============================================================================
-- COUPLES BOOKING FIX - APPLY THESE MIGRATIONS IN SUPABASE SQL EDITOR
-- ============================================================================
-- This combines migrations 032 and 033 to fix couples booking issues
-- Run this entire script in your Supabase SQL Editor

-- ============================================================================
-- MIGRATION 032: Remove full_payment option from payment_option constraint
-- ============================================================================
...
-- Drop the old constraint name as well (from earlier migrations)
ALTER TABLE public.bookings 
...
-- Drop and recreate the couples booking function with payment_option support
...
-- ============================================================================
-- VERIFICATION QUERIES (Optional - run these to verify the changes worked)
-- ============================================================================

-- Check the new constraint (updated for modern PostgreSQL)
SELECT conname, pg_get_constraintdef(oid) as constraint_definition
FROM pg_constraint 
WHERE conrelid = 'public.bookings'::regclass 
AND conname LIKE '%payment_option%';

-- Check the function exists and has the right parameters
SELECT p.proname, p.pronargs, pg_get_function_arguments(p.oid) as arguments
FROM pg_proc p
WHERE p.proname = 'process_couples_booking_v3';

-- Check default value for payment_option
