-- Remove capacity check from process_couples_booking_v2 function
-- This temporarily removes the room capacity validation for couples bookings
...
BEGIN
    ...
    -- REMOVED: Room capacity check for couples bookings
    -- The capacity check has been temporarily disabled
...
-- Comment
COMMENT ON FUNCTION process_couples_booking_v2 IS 'Creates couples bookings with room capacity check temporarily disabled';