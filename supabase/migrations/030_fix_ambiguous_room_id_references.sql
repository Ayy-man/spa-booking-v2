-- Fix ambiguous column reference errors in couples booking function
-- This addresses the PostgreSQL error: "column reference 'room_id' is ambiguous"

-- Drop and recreate the couples booking function with properly qualified column references
...
COMMENT ON FUNCTION process_couples_booking_v3 IS 'Creates couples bookings with individual duration calculations, staff resolution validation, and preferred room assignment (Room 3 > Room 2). Fixed ambiguous column references with proper table aliases.';