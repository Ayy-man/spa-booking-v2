-- Fix process_couples_booking_v2 with correct parameter order matching frontend
-- This migration updates the function to match how the frontend is calling it
...
-- Comment
COMMENT ON FUNCTION process_couples_booking_v2 IS 'Creates couples bookings with parameter order matching frontend calls';