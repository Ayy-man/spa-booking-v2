-- Fix couples booking function to match frontend expectations
-- This creates a new function that handles potentially different services for each person
...
COMMENT ON FUNCTION process_couples_booking_v2 IS 'Creates couples bookings with potentially different services for each person';