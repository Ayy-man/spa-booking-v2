-- Migration: Update Staff Schedules and Add Service Exclusions (SIMPLIFIED)
...
-- Update Leonel Sidon: Just set exclusions (no capability changes)
-- Note: Leonel can already assist with facials on Sundays based on business requirements
UPDATE staff SET 
