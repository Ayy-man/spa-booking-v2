-- Migration: Update Staff Schedules and Add Service Exclusions
...
-- Update Leonel Sidon: Add facial assist capability
UPDATE staff SET 
  capabilities = CASE 
    WHEN 'facial_assist' = ANY(capabilities) THEN capabilities
    ELSE array_append(capabilities, 'facial_assist')
  END,
