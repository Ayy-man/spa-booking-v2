-- Migration: 032_fix_couples_booking_function.sql
-- Purpose: Fix couples booking function with proper room assignment and error handling
-- Date: 2025-01-17
...
EXCEPTION
    WHEN OTHERS THEN
        -- Clean up any partial bookings (with table alias to avoid ambiguity)
...
-- Add comment
COMMENT ON FUNCTION process_couples_booking_v2 IS 'Creates couples bookings with proper room assignment. Fixed: ambiguous column references, room availability checking, and different service durations. Migration 032.';