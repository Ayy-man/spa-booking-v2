-- =====================================================
-- COUPLES BOOKING MIGRATION - FINAL WORKING VERSION
-- Based on actual database schema - no missing columns!
-- =====================================================
...
-- Based on Supabase AI suggestion, but let's be even more conservative
UPDATE services 
...
BEGIN
    ...
    -- Based on your seed data: Room 3 (id=3, capacity=2), Room 2 (id=2, capacity=2)
    SELECT id INTO v_room_id 
    FROM rooms 
    WHERE id IN (3, 2) AND is_active = true 
    AND NOT EXISTS (
...
-- Success message
SELECT 'Couples booking migration completed successfully! No missing columns.' as result;