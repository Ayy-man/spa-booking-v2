-- =====================================================
-- COUPLES BOOKING MIGRATION - ULTRA SAFE VERSION
-- Avoids all category enum issues by using only existing columns
-- =====================================================
...
-- Update services to mark couples services (using only safe columns)
-- Avoid any category comparisons that might hit enum issues
UPDATE services 
...
BEGIN
    ...
    -- Simple room assignment for couples: prefer Room 3, then Room 2
    -- These rooms have capacity >= 2 based on your seed data
...
-- Success message
SELECT 'Couples booking migration completed successfully! Avoided all enum issues.' as result;