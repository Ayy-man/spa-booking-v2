-- =====================================================
-- COUPLES BOOKING MIGRATION - PARAMETER ORDER FIXED
-- Thanks to Supabase AI for catching the parameter default issue!
-- =====================================================
...
-- Success message
SELECT 'Couples booking migration completed successfully! Parameter order fixed.' as result;